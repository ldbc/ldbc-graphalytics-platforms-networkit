 ...
 * @author Balint Hegyi
 */
public final class NetworkitConfiguration {
	...
	/**
	 * Creates a new NetworKitConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public NetworkitConfiguration(){
	}
	...
	public static NetworkitConfiguration parsePropertiesFile() {

		NetworkitConfiguration platformConfig = new NetworkitConfiguration();
