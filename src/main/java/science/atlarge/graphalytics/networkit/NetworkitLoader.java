 ...
 * @author Balint Hegyi
 */
public class NetworkitLoader {

	private static final Logger LOG = LogManager.getLogger();

	protected CommandLine commandLine;
	protected FormattedGraph formattedGraph;
	protected NetworkitConfiguration platformConfig;


	/**
	 *	Graph loader for NetworKit.
	 * @param formattedGraph
	 * @param platformConfig
	 */
	public NetworkitLoader(FormattedGraph formattedGraph, NetworkitConfiguration platformConfig) {
