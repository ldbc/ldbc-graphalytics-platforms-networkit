 ...
 */
package science.atlarge.graphalytics.networkit.algorithms.cdlp;
...
/**
 * Community Detection job implementation for NetworKit. This class is responsible for formatting CDLP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Balint Hegyi
 */
public final class CommunityDetectionLPJob extends NetworkitJob {
	 ...
	 */
	public CommunityDetectionLPJob(RunSpecification runSpecification, NetworkitConfiguration platformConfig,
