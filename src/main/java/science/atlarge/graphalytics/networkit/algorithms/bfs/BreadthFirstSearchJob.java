 ...
 */
package science.atlarge.graphalytics.networkit.algorithms.bfs;
...
/**
 * Breadth-first Search job implementation for NetworKit. This class is responsible for formatting BFS-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Balint Hegyi
 */
public final class BreadthFirstSearchJob extends NetworkitJob {
	 ...
	 */
	public BreadthFirstSearchJob(RunSpecification runSpecification, NetworkitConfiguration platformConfig,
