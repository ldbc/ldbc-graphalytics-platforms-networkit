 ...
 */
package science.atlarge.graphalytics.networkit.algorithms.sssp;
...
/**
 * Single Source Shortest Paths job implementation for NetworKit. This class is responsible for formatting SSSP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Balint Hegyi
 */
public final class SingleSourceShortestPathsJob extends NetworkitJob {
	...
	public SingleSourceShortestPathsJob(RunSpecification runSpecification,
										NetworkitConfiguration platformConfig,
